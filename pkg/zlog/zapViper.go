...
// return zap.Logger by viper config file
//	canWriteLogFile set true is write to file
//file set as yaml like
//	config.yml
//zap:
...
func LoggerByViper(canWriteLogFile bool) *zap.Logger {
